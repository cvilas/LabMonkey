...
// Test program for faulhaber motor controllers with serial input
// - commands must be terminated by carriage return (eg: "1EN\r")
// - replies from the controller are terminated by newline (eg: "OK\r\n")
